...
// ------------------------------------------------------------
// Grouped into categories. Each item: title, description, date,
// image, tags, and a `link` (an internal article slug like
// "/articles/the-power-brokers" or an external URL).
// ============================================================
...
export const portfolioItems = [
  ...
  {
    category: "Interviews",
    title: "The Women Rewriting Energy",
    description:
  ...
  {
    category: "Interviews",
    title: "The Librarian of the Last Archive",
    description:
